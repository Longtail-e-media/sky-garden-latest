    ...
    <div class="example-code">
        <form action="" class="col-md-12 center-margin" id="Preference_frm">
            ...
            <div class="form-row">
                ...
                <?php endif; ?>
                <div class="form-input col-md-10 uploader10 <?php echo !empty($PrefeRow->logo_upload_dark) ? "hide" : ""; ?>">
            ...
            <div class="form-row">
                ...
                <div class="col-md-2" id="removeSavedimg20">
                    <div class="infobox info-bg">                            	                                
                        ...
                        <input type="hidden" name="imageArrayname20" value="<?= $PrefeRow->default_banner_upload; ?>" class="" />
                    </div> 
                </div>
                <?php endif;?>
                <div class="form-input col-md-10 uploader20 <?php echo !empty($PrefeRow->default_banner_upload)?"hide":"";?>">          
