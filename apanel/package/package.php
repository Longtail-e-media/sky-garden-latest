        ...
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="package_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Homepage Title" class="col-md-6 validate[required,length[0,200]]" type="text"
                               name="home_title" id="home_title"
                               value='<?php echo !empty($packageInfo->home_title) ? $packageInfo->home_title : ""; ?>'>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-label col-md-2">
                ...
                <div class="form-row add-image">
                    ...
                    <div class="form-input col-md-10 uploader">
                        ...
                        <label>
                            <small>Image Dimensions (738 px X 492 px)</small>
                        </label>
                    </div>
                ...
                <div class="form-row">
                    ...
                    if (!empty($packageInfo->header_image)):
                        ...
                        if ($imageRec):
                            foreach ($imageRec as $k => $imageRow): ?>
                                <div class="col-md-3" id="removeSavedimg1<?php echo $k; ?>">
                                    <div class="infobox info-bg">
                                        <div class="button-group" data-toggle="buttons">
                                    <span class="float-left">
                                        <?php
                                        ...
                                        ?>
                                            ...
                                            <a class="btn small float-right" href="javascript:void(0);"
                                               onclick="deleteSavedPackageimage(1<?php echo $k; ?>);">
                                                <i class="glyph-icon icon-trash-o"></i>
                                            </a>
                                        </div>
            ...
            $('#header_upload').uploadify({
                ...
                'onUploadSuccess': function (file, data, response) {
                    ...
                    $.post('<?php echo BASE_URL;?>apanel/package/header_image.php', {imagefile: filename}, function (msg) {
                        $('#preview_himage').append(msg).show();
                    });
                },
                'onDialogOpen': function (event, ID, fileObj) {
                },
