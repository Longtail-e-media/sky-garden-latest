            ...
            <form action="" class="col-md-12 center-margin" id="subpackage_frm">
                ...
                <div class="form-row add-image">
                    ...
                    <div class="form-input col-md-10 uploader">
                        ...
                        <label>
                            <small>Image Dimensions (1203 px X 513 px)</small>
                        </label>
                    </div>
                ...
                <?php if ($pkg->type == 1) { ?>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Bed Type" class="col-md-3 validate[length[0,3]]" type="text"
                                   name="extra_bed" id="extra_bed"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Room Size" class="col-md-3" type="text" name="room_size"
                                   id="room_size"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Check In/Out" class="col-md-3" type="text" name="checkinout"
                                   id="checkinout"
                ...
                <?php if ($pkg->id == 6) { ?>
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Hall Size" class="col-md-3" type="text" name="room_size"
                                   id="room_size"
                                   value="<?php echo !empty($subpackageInfo->room_size) ? $subpackageInfo->room_size : ''; ?>">
                        </div>
                    </div>
                ...
                <?php if ($pkg->id == 7) { ?>
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Capacity " class="col-md-3 validate[length[0,3]]" type="text"
                                   name="occupancy" id="occupancy"
                                   value="<?php echo !empty($subpackageInfo->occupancy) ? $subpackageInfo->occupancy : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Type" class="col-md-3 validate[length[0,3]]" type="text"
                                   name="extra_bed" id="extra_bed"
                                   value="<?php echo !empty($subpackageInfo->extra_bed) ? $subpackageInfo->extra_bed : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Timing" class="col-md-3" type="text" name="checkinout"
                                   id="checkinout"
                                   value="<?php echo !empty($subpackageInfo->checkinout) ? $subpackageInfo->checkinout : ''; ?>">
                        </div>
                    </div>
