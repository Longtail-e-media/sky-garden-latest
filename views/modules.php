...
$jVars['site:copyright']	= ''.str_replace('{year}',date('Y'),$siteRegulars->copyright).' Developed by <a href="https://longtail.info/" target="_blank" rel = "noopener noreferror">Longtail e-media</a>';
...
$jVars['site:default-img']			= ' style="background: url(' . IMAGE_PATH . 'preference/banner/' . $siteRegulars->default_banner_upload . ') no-repeat !important;" ';	
