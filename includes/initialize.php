...
if($online)
{
	...
	defined('SITE_ROOT')  		? NULL : define('SITE_ROOT', $_SERVER['DOCUMENT_ROOT'].DS.'dynamic'.DS);
	defined('BASE_URL')   		? NULL : define('BASE_URL', $base_protocol.'://'.$_SERVER['HTTP_HOST'].'/dynamic/');
} else {
...
defined('DEVELOPED_BY')			? NULL : define('DEVELOPED_BY', 'Longtail e-media Pvt. Ltd.');
