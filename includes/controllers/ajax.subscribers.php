...
// 			$mail->MsgHTML($body);
            ...
            $to      = $email;
            $subject = 'Subscription sucessfull';
            $message = 'Thank you for subscribing to our promotion & news.';
            $headers = 'From: info@hotelghyampedanda.com' . "\r\n" .
